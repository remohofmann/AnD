...
public class MergeSortInteger implements DivideAndConquerable<Integer> {
    ...
    public MergeSortInteger(Integer[] dataArray, Integer[] auxArray, int left, int right) {
    ...
    public List<? extends DivideAndConquerable<Integer>> decompose() {
        ...
        this.j = mid + 1;
        this.k = left;
        decomposedList.add(new MergeSortInteger(dataArray, auxArray, left, mid));
        decomposedList.add(new MergeSortInteger(dataArray, auxArray, mid + 1, right));
