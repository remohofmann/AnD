...
public class MergeSortIntegerSimple implements DivideAndConquerable<Integer> {
    ...
    public MergeSortIntegerSimple(Integer[] dataArray, Integer[] auxArray, int left, int right) {
    ...
    public List<? extends DivideAndConquerable<Integer>> decompose() {
        ...
        this.j = mid + 1;
        this.k = left;
        decomposedList.add(new MergeSortIntegerSimple(dataArray, auxArray, left, mid));
        decomposedList.add(new MergeSortIntegerSimple(dataArray, auxArray, mid + 1, right));
